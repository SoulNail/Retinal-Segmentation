...
from models.Additional.DWT.DWT_layer import DWT_1D, IDWT_1D, DWT_2D_tiny, DWT_2D, IDWT_2D
...
if __name__ == '__main__':
    ...
    img = imageio.imread(r'datasets/DRIVE/train/label/21.png')  # array (255,255,3)
